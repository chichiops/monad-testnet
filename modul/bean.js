...
async function runBeanProcess(wallet, cycles = 1) {
  txLogger.logInfo(wallet.address, "Bean", "Process Started", `Starting ${cycles} cycles`);
  console.log(`🪫  Starting Bean ⏩⏩⏩⏩`.blue);
...
module.exports = { runBeanProcess, main };